...
const getDataInternal = async (chromToDisplay) => {
  ...
  Object.values(pivots).forEach((chomPivot) => {
    Object.values(chomPivot).forEach((pivotPaths) => {
      Object.values(pivotPaths).forEach((pivotPath) => {
        pivotPath.array.forEach((pivotStep) => {
