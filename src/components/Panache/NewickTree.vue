<template>
  <div>
    <b-button id="newickTreeDisplayButton" :class="isNewickTreeDisplayed ? 'newickDisplayed' : null" block
              class="buttonPanache" size="sm" variant="light"
              @click="displayNewickTree">{{ displayed ? "Hide newick tree" : "Display newick tree" }}
    </b-button>
  </div>
</template>
